# utils/chart_creator.py — نسخه Google Sheets
...
from utils.sheets_storage import read_from_sheets  # ← تغییر اینجا

logger = logging.getLogger(__name__)

def create_market_charts():
    """
    ساخت نمودار ۵ خطی زنده از داده‌های Google Sheets
    """
    try:
        # خواندن از Google Sheets
        data_rows = read_from_sheets(limit=500)  # 500 ردیف اخیر
        ...
        numeric_cols = df.columns[1:]  # همه به جز timestamp
