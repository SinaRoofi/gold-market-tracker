...
<b>قیمت:</b> {gold_24_price:,.2f}
تغییر: {gold_24['close_price_change_percent'] / 10:+.2f}% | حباب: {gold_24['Bubble'] / 10:+.2f}%

🔸 <b style='font-size:18px'>طلا ۱۸ عیار</b>
<b>قیمت:</b> {gold_18_price:,.2f}
تغییر: {gold_18['close_price_change_percent'] / 10:+.2f}% | حباب: {gold_18['Bubble'] / 10:+.2f}%

🪙 <b style='font-size:18px'>سکه امامی طرح جدید</b>
<b>قیمت:</b> {sekeh_price:,.2f}
تغییر: {sekeh['close_price_change_percent'] / 10:+.2f}% | حباب: {sekeh['Bubble'] / 10:+.2f}%
