...
DOLLAR_HIGH = 117_000      # آستانه بالای دلار (تومان)
DOLLAR_LOW = 116_000       # آستانه پایین دلار

SHAMS_HIGH = 16_000_000    # آستانه بالای شمش طلا 
SHAMS_LOW = 15_000_000     # آستانه پایین شمش طلا 

GOLD_HIGH = 4230           # آستانه بالای اونس طلا
GOLD_LOW = 4080            # آستانه پایین اونس طلا
...
DEFAULT_DOLLAR_PRICE = 119100   # قیمت پیش‌فرض دلار (تومان)

# 📌 هندل کانال تلگرام
CHANNEL_HANDLE = "@Gold_Iran_Market"
ALERT_CHANNEL_HANDEL = "@ALERT_GOLD"
# ════════════════════════════════════════════════════════════════
