...
# ════════════════════════════════════════════════════════════════
# ⚙️ تنظیمات دستی - اینجا رو ویرایش کنید
# ════════════════════════════════════════════════════════════════

# 🚨 آستانه‌های هشدار قیمتی
DOLLAR_HIGH = 116_000      # آستانه بالای دلار (تومان)
DOLLAR_LOW = 115_500       # آستانه پایین دلار (تومان)

SHAMS_HIGH = 16_000_000    # آستانه بالای شمش طلا (ریال)
SHAMS_LOW = 15_000_000     # آستانه پایین شمش طلا (ریال)

GOLD_HIGH = 4230           # آستانه بالای اونس طلا (دلار)
GOLD_LOW = 4080            # آستانه پایین اونس طلا (دلار)

ALERT_THRESHOLD_PERCENT = 0.5   # درصد تغییر سریع برای هشدار (%)
EKHTELAF_THRESHOLD = 10         # تغییر اختلاف سرانه برای هشدار (میلیون تومان)

# 🎯 مقادیر پیش‌فرض (Fallback)
DEFAULT_GOLD_PRICE = 4200       # قیمت پیش‌فرض اونس طلا (دلار)
DEFAULT_DOLLAR_PRICE = 115900   # قیمت پیش‌فرض دلار (تومان)
