...
DOLLAR_HIGH = 157_500      # آستانه بالای دلار
DOLLAR_LOW = 156_000       # آستانه پایین دلار

SHAMS_HIGH = 27_000_000    # آستانه بالای شمش طلا 
SHAMS_LOW = 26_000_000     # آستانه پایین شمش طلا 

GOLD_HIGH = 5300         # آستانه بالای اونس طلا
GOLD_LOW = 5000       # آستانه پایین اونس طلا

ALERT_THRESHOLD_PERCENT = 0.5  # درصد تغییر سریع 
EKHTELAF_THRESHOLD = 10         # اختلاف سرانه (میلیون تومان)

# 🎯 مقادیر پیش‌فرض (Fallback)
DEFAULT_GOLD_PRICE = 5280     
DEFAULT_DOLLAR_PRICE = 156_000 
